...
<div class="panel panel-primary">
	<div style="text-align: center;" class="panel-heading">
		<span class="badge pull-left"><span id="toUserDatatable"
			class="glyphicon glyphicon-arrow-left"></span></span>Ödeme
	</div>
									...
									<div class="col-xs-7 col-md-7">
										<div class="form-group">
											<label for="cardExpiry"><span class="hidden-xs">Son
													Kullanma Tarihi</span><span class="visible-xs-inline">EXP</span>
												DATE</label> <input type="tel" class="form-control"
												name="cardExpiry" placeholder="MM / YY" required />
										</div>
									</div>
								...
								<div class="row">
									<div class="col-xs-12">
										<button class="subscribe btn btn-success btn-lg btn-block"
											id="paymentButton"
											data-href="<c:url value='/user/debt/payment?' />"
											type="button">Öde</button>
									</div>
								</div>
